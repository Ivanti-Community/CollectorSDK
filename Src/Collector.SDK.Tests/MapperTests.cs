...
namespace Collector.SDK.Tests
{
    ...
    public class MapperTests
    {
        ...
        private const string TYPE_MOCKUSER = "Collector.SDK.Tests.Mocks.MockUser,Collector.SDK.Tests";
        private const string TYPE_DATE_TIME_COMBINE_CONVERTER = "Collector.SDK.Converters.CombineDateTimeConverter,Collector.SDK";
        private const string TYPE_DATE_TIME_UTC_CONVERTER = "Collector.SDK.Converters.DateTimeUtcConverter,Collector.SDK";
        private const string TYPE_UPPER_CASE_CONVERTER = "Collector.SDK.Converters.AllUpperCaseConverter,Collector.SDK";
