...
namespace Collector.SDK.Tests
{
    ...
    {
        public const string TYPE_COLLECTOR = "Collector.SDK.Tests.Mocks.MockCollector, Collector.SDK.Tests";
        public const string TYPE_STACK = "Collector.SDK.Tests.Mocks.MockStack, Collector.SDK.Tests";
        public const string TYPE_CONVERTER = "Collector.SDK.Tests.Mocks.MockConverter, Collector.SDK.Tests";
        public const string TYPE_READER = "Collector.SDK.Tests.Mocks.MockReader, Collector.SDK.Tests";
        ...
        public const string TYPE_MAPPER = "Collector.SDK.Tests.Mocks.MockMapper, Collector.SDK.Tests";
        public const string TYPE_TRANSFORMER = "Collector.SDK.Tests.Mocks.MockTransformer, Collector.SDK.Tests";
        public const string TYPE_TRANSFORMATION_HANDLER = "Collector.SDK.Tests.Mocks.MockTransformationHandler, Collector.SDK.Tests";
        public const string TYPE_PUBLISHER = "Collector.SDK.Tests.Mocks.MockPublisher, Collector.SDK.Tests";
        public const string TYPE_DATA = "Collector.SDK.Tests.Mocks.MockEntity, Collector.SDK.Tests";
