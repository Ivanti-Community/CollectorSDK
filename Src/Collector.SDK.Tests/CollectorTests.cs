...
namespace Collector.SDK.Tests
{
    ...
    {
        public const string TYPE_SERIAL_COLLECTOR = "Collector.SDK.Collectors.SerialCollector, Collector.SDK";
        public const string TYPE_SERIAL_STACK = "Collector.SDK.Collectors.Stack, Collector.SDK";
        public const string TYPE_INFINITE_READER = "Collector.SDK.Tests.Mocks.MockInfiniteReader, Collector.SDK.Tests";
