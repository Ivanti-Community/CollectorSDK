...
namespace Collector.SDK.Samples.Tests
{
    ...
    {
        private static readonly string TYPE_FOLDER_MONITOR_COLLECTOR = "Collector.SDK.Samples.Collectors.FolderMonitorCollector, Collector.SDK.Samples.Collectors";
        private static readonly string TYPE_LOG_PUBLISHER = "Collector.SDK.Samples.Publishers.LogPublisher, Collector.SDK.Samples.Publishers";
        private static readonly string TYPE_SAMPLE_TRANSFORMER = "Collector.SDK.Samples.Transformers.SampleTransformer, Collector.SDK.Samples.Transformers";
        private static readonly string TYPE_SAMPLE_DIRECTORY = "Collector.SDK.Samples.Collectors.Folder, Collector.SDK.Samples.Collectors";
